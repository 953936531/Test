      ...
      <div class="container">
        <div class="row intro-text align-items-center justify-content-center">
          <div class="col-md-10 text-center">
            <h1 class="site-heading site-animate">你好, 我是 <strong>张 江彪</strong></h1>
            <p class="lead site-subheading mb-4 site-animate">一个在上海工作的开发,每天都在成长,PHP是世界上最好的语言;</p>
            <p><a href="#section-about" class="smoothscroll btn btn-primary px-4 py-3">我的详情</a></p>
          </div>
        </div>
      </div>
    </section> <!-- section -->
      ...
      <div class="container">
        <div class="row mb-5 align-items-center">
          <div class="col-lg-7 pr-lg-5 mb-5 mb-lg-0">
            <img src="/images/image_1_long.jpg?v=111" alt="Image placeholder" class="img-fluid">
          </div>
          <div class="col-lg-5 pl-lg-5">
            <div class="section-heading">
              <h2>About <strong>Me</strong></h2>
            </div>
            <p class="lead">我本人外向,乐观,拥有较强学习能力,大专学历,2年实际开发经验,有过为期10个月的全栈培训经历;</p>
            <p class="mb-5">来自山西运城的20岁小伙子,年轻富有挑战精神,爱好竞技游戏,面对失败习惯对自身做总结!</p>
        ...
        <div class="row pt-5">
          ...
          <div class="col-md-9">
            ...
            <div class="skill">
              <h3>MVC and OOP</h3>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 96%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                  <span>96%</span>
                </div>
              </div>
            </div>
            <div class="skill">
              ...
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 80%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                  <span>80%</span>
                </div>
              </div>
            </div>
            <div class="skill">
              <h3>ThinkPHP And Laravel And Symfony</h3>
              <div class="progress">
                <div class="progress-bar" role="progressbar" style="width: 80%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
                  <span>80%</span>
                </div>
